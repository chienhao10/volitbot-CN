...
namespace LoLLauncher.RiotObjects.Platform.Systemstate
{
	public class ClientSystemStatesNotification : RiotGamesObject
	{
		...
		public bool ChampionTradeThroughLCDS
		{
			get;
			set;
		}
		...
		public int[] PracticeGameTypeConfigIdList
		{
			get;
			set;
		}
		...
		public int[] FreeToPlayChampionIdList
		{
			get;
			set;
		}
		...
		public object[] InactiveChampionIdList
		{
			get;
			set;
		}
		...
		public int[] InactiveSpellIdList
		{
			get;
			set;
		}
		...
		public int[] InactiveTutorialSpellIdList
		{
			get;
			set;
		}
		...
		public int[] InactiveClassicSpellIdList
		{
			get;
			set;
		}
		...
		public int[] InactiveOdinSpellIdList
		{
			get;
			set;
		}
		...
		public int[] InactiveAramSpellIdList
		{
			get;
			set;
		}
		...
		public int[] EnabledQueueIdsList
		{
			get;
			set;
		}
		...
		public int[] UnobtainableChampionSkinIDList
		{
			get;
			set;
		}
		...
		public Dictionary<string, object> QueueThrottleDTO
		{
			get;
			set;
		}
		...
		public List<Dictionary<string, object>> GameMapEnabledDTOList
		{
			get;
			set;
		}
		...
		public string ObservableCustomGameModes
		{
			get;
			set;
		}
		...
		public bool LeagueServiceEnabled
		{
			get;
			set;
		}
		...
		public int RiotDataServiceDataSendProbability
		{
			get;
			set;
		}
		...
		public bool LocaleSpecificChatRoomsEnabled
		{
			get;
			set;
		}
		...
		public Dictionary<string, object> ReplaySystemStates
		{
			get;
			set;
		}
		...
		public bool SendFeedbackEventsEnabled
		{
			get;
			set;
		}
		...
		public string[] KnownGeographicGameServerRegions
		{
			get;
			set;
		}
		...
		public bool LeaguesDecayMessagingEnabled
		{
			get;
			set;
		}
