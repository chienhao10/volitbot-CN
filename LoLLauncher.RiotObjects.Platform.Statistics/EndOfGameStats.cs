...
namespace LoLLauncher.RiotObjects.Platform.Statistics
{
	public class EndOfGameStats : RiotGamesObject
	{
		...
		public double LoyaltyBoostIpEarned
		{
			get;
			set;
		}
		...
		public double TimeUntilNextFirstWinBonus
		{
			get;
			set;
		}
		...
		public double LoyaltyBoostXpEarned
		{
			get;
			set;
		}
